...
class ConfigSingleton:
    ...
    def _load_config(self):
        ...
        try:
            ...
            self.config = {}  # Pokud soubor neexistuje nebo je špatně formátovaný,
                              # nastavíme prázdný dict
    ...
    def get_print_content(self, max_length=40):
        ...
        def truncate(value, max_length=40):
            """ Omezí délku na max_length znaků tak, že
                vezme první třetinu a poslední
                dvě třetiny, mezi ně vloží '...'."""
            value_str = str(value)
            ...
            # První třetina
            part1 = max_length // 3
            # Poslední část, mínus tři znaky na '...'
            part2 = max_length - part1 - 3

            return value_str[:part1] + "..." + value_str[-part2:]

        truncated_config = {truncate(k, max_length):
                            truncate(v, max_length) for k, v in self.config.items()}
